...
# 🚀 Page configuration
st.set_page_config(page_title="Sandra Silva", layout="centered", page_icon="📊")

# 📊 Title
st.title("📊 Sandra Silva")
...
# 📥 Load data
url = "https://raw.githubusercontent.com/paulom40/PFonseca.py/main/SSilva.xlsx"
try:
...
if st.button("🔄 Atualizar Dados"):
    st.rerun()
st.write("📅 Last Update 03/10/2025")
# 📋 Summary
st.subheader("📋 Resumo")
summary = []
